...
public class ServerUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btlistclient = new javax.swing.JButton();
        ...
        btlistclient.setText("Xem danh sách client");
        btlistclient.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btlistclientActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(63, 63, 63)
                        .addComponent(btlistclient, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btlistclient, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btlistclientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btlistclientActionPerformed
        // TODO add your handling code here:
        DefaultListModel<String> modelList = new DefaultListModel<>(); 
        for (ServerDefine serverDefine : listServer) {
            if (serverDefine.getServerSocket().getLocalPort()==Integer.parseInt(listRoom.getSelectedValue()))
            {
                for (ClientDefine cd : serverDefine.getClientList()) {
                    modelList.addElement(cd.getClientName());
                }
            }
        }
        ListClient client = new ListClient(modelList);
        client.setVisible(true);
    }//GEN-LAST:event_btlistclientActionPerformed
    ...
    private javax.swing.JButton btlistclient;
